...
export const products: Product[] = [
  {
    ...
    specs: [
      ...
      { label: "Código do Produto", value: "TCH-ELG-001" }
    ]
  },
  {
    id: "2",
    ...
    specs: [
      ...
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "TCH-SQR-002" }
    ]
  },
  {
    id: "3",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "TCH-SPT-003" }
    ]
  },
  {
    id: "4",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "TCH-SLM-004" }
    ]
  },
  {
    id: "5",
    ...
    specs: [
      ...
      { label: "Código do Produto", value: "TCH-RIV-005" }
    ]
  },
  {
    id: "6",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "3 Anos" },
      { label: "Código do Produto", value: "TCH-RIV-006" }
    ]
  },
  {
    id: "7",
    ...
    specs: [
      ...
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "TCH-CRY-007" }
    ]
  },
  {
    id: "8",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "TCH-CLS-008" }
    ]
  },
  {
    id: "9",
    name: "TECHNOS CHAIN LUXURY",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "3 Anos" },
      { label: "Código do Produto", value: "TCH-CHN-009" }
    ]
  },
  {
    id: "10",
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "30M" },
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "OCK-CRY-011" }
    ]
  },
  {
    id: "12",
    name: "O'CLOCK CLASSIC NAVY",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "OCK-NVY-012" }
    ]
  },
  {
    id: "13",
    name: "O'CLOCK GOLF PROFESSIONAL",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "50M" },
      { label: "Garantia", value: "2 Anos" },
      { label: "Código do Produto", value: "OCK-GLF-013" }
    ]
  },
  {
    id: "14",
    name: "O'CLOCK DIVER BLACK",
    ...
    specs: [
      ...
      { label: "Garantia", value: "3 Anos" },
      { label: "Código do Produto", value: "OCK-DVR-014" }
    ]
  },
  {
    id: "15",
    name: "O'CLOCK DIVER GREEN",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "150M" },
      { label: "Garantia", value: "3 Anos" },
      { label: "Código do Produto", value: "OCK-GRN-015" }
    ]
  },
  {
    id: "16",
    name: "O'CLOCK DIVER ROSE",
    ...
    specs: [
      ...
      { label: "Resistência à Água", value: "150M" },
      { label: "Garantia", value: "3 Anos" },
      { label: "Código do Produto", value: "OCK-RSE-016" }
    ]
  },
  {
    id: "17",
    name: "O'CLOCK AUTOMATIC GOLD",
    ...
    specs: [
      ...
      { label: "Código do Produto", value: "OCK-AUT-017" }
    ]
  }
];